...
export default class EscrowTopicManager {
    /**
    ...
    async identifyAdmissibleOutputs(beef, previousCoins) {
        ...
        try {
            ...
            throw new Error(`topicManager:Error:identifying admissible outputs:${error} beef:${beefStr}}`);
        }
        return {
            outputsToAdmit,
...
//# sourceMappingURL=EscrowTopicManager.js.map