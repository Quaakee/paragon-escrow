...
export const findNearestPackageJson = async ({ cwd }) => {
    ...
    return JSON.parse(await fs.readFile(packageJsonFilePath, "utf-8"));
};
export const findTsConfig = async ({ targetTsConfigFilePaths, cwd }) => {
...
export const createModuleTypePackage = async ({ cwd, type, debug }) => {
...
export const tsconfigToDualPackages = async ({ targetTsConfigFilePaths, cwd, debug }) => {
